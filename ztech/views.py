...
class PortListView(ListView):
    model = Tech
    template_name = 'ztech/index.html'
...
class UploadPortView(CreateView):
    ...
    success_url = reverse_lazy('ztech:index')
    template_name = 'ztech/upload.html'
...
class UploadBookView(CreateView):
    ...
    success_url = reverse_lazy('ztech:index')
    template_name = 'ztech/create.html'
