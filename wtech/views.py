...
class PortListView(ListView):
    model = Tech
    template_name = 'wtech/index.html'
...
class UploadPortView(CreateView):
    ...
    success_url = reverse_lazy('wtech:index')
    template_name = 'wtech/upload.html'
...
class UploadBookView(CreateView):
    ...
    success_url = reverse_lazy('wtech:index')
    template_name = 'wtech/create.html'
