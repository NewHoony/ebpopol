...
class PortListView(ListView):
    model = Tech
    template_name = 'ytech/index.html'
...
class UploadPortView(CreateView):
    ...
    success_url = reverse_lazy('ytech:index')
    template_name = 'ytech/upload.html'
...
class UploadBookView(CreateView):
    ...
    success_url = reverse_lazy('ytech:index')
    template_name = 'ytech/create.html'
